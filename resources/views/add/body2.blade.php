        ...
        <div class="mr-lg-50">
          ...
          <div class="row">
            <div class="col-sm-6 mb-30">
              ...
              <div class="input input-blue">
                <input type="number" name="price" id="price" min="0" autocomplete="one-time-code" v-model="price">
                <span class="symbol">
            ...
            <div class="col-sm-6 mb-30">
              ...
              <div class="input input-blue">
                <input type="number"  name="price" id="price" min="0" autocomplete="one-time-code" v-model="regular_price">
                <span class="symbol">
                  <i class="fas fa-euro-sign"></i>
                </span>
              </div>
          ...
          <div class="row mb-30">
            ...
            <div class="col-sm-6">
              ...
              <div class="input input-blue">
                <input type="number" autocomplete="one-time-code" v-model="shipping_cost" :disabled="free_shipping">
                <span class="symbol">
                  <i class="fas fa-euro-sign"></i>
                </span>
              </div>
          ...
          @if($admin == 1 && isset($item))
            <div class="mt-20 mb-30">
              ...
              <div class="mt-20 mb-30">
                ...
                <select class="from-control" v-model="updated_at_time">
                  <option>00:00</option>
                  <option>01:00</option>
                  <option>02:00</option>
                  <option>03:00</option>
