<div id="pagination" class="pagination mt-15 mb-25 my-lg-30" v-show="items.length >= pagination">
  ...
  <span class="go_footer" @click="scrollToFooter()">Mostrar el pie de página <i class="fas fa-caret-down"></i></span>
</div>